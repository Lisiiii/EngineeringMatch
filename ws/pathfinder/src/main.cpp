...
int main()
{
    ...
    auto image_processer = std::make_shared<image::ImageProcesser>("ImageProcesser", 1);
    ...
    auto state_machine = std::make_shared<state_machine::StateMachine>("StateMachine", 1, image_processer);
    state_machine->start();
